local Types = (getgenv and getgenv().Types) or loadstring(game:HttpGet("https://raw.githubusercontent.com/GhostDuckyy/UI-Libraries/main/ImGui/Iris/Versions/2.0.5/Misc/Types.lua"))()
